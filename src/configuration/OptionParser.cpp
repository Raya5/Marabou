...
void OptionParser::initialize()
{
    ...
    _other.add_options()(
        ...
        "incremental-mode",
        boost::program_options::bool_switch( &( ( *_boolOptions )[Options::INCREMENTAL_MODE] ) )
            ->default_value( ( *_boolOptions )[Options::INCREMENTAL_MODE] ),
        "Use the incremental conflict analyser." )
#ifdef ENABLE_GUROBI
#endif // ENABLE_GUROBI
        ;
